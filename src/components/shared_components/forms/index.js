...
export default (props) => {
    ...
    const formToRender = ()=> {
      ...
      if(formType == formTypes.newVehicle) {
        ...
        return <NewVehicleForm isUpdate={isUpdatingData} data={data}/>
        
      }else if(formType == formTypes.newUser) {
        //new User form

        return <NewUserForm isUpdate={isUpdatingData} data={data} />
        
      }
      else if(formType == formTypes.newPenalty) {
        //new User form

        return <NewPenaltyForm isUpdate={isUpdatingData} data={data} />
        ...
        return <TemplateForm title={title}  isUpdate={isUpdatingData} data={data}/>
      }
    }
